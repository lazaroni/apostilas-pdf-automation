...
def main():
    ...
    sigla = input("⚙️ 1. Informe a sigla utilizada pela apostila personalizada: ").strip().upper()

    # Escolha da cor do texto
    print("\n⚙️ 2. Escolha a cor do texto estampado no PDF:")
    ...
    print("\n⚙️ 3. Você já possui um arquivo PDF compatível?")
    print("1. Sim")
    print("2. Não")
    opcao_pdf_compativel = input("Digite 1 ou 2: ").strip()

    # Seleção do PDF-base
    print("\n⚙️ 4. Selecione o arquivo PDF:")
